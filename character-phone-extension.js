...
class CharacterPhoneExtension {
    ...
    async init() {
        log('Initializing Character Phone Extension v7.1...');
        ...
        try {
            ...
            log('🆕 Version 7.1 - Now in Extensions Menu!');
    ...
    /**
     * Create main menu UI (following Memory Books extension pattern)
     */
    createUI() {
        log('Creating Character Phone menu item...');

        const menuItem = $(
            `
            <div id="character-phone-menu-container" class="extension_container interactable" tabindex="0">
        ...
        if (extensionsMenu.length > 0) {
            ...
            log('Menu item added to Extensions Menu');
        } else {
            console.warn('[CharacterPhone] Extensions menu not found');
        }
    }
    ...
    registerEventListeners() {
        ...
        const self = this;
        $(document).on('click', '#character-phone-menu-item', async function(e) {
            e.preventDefault();
            e.stopPropagation();

            console.log('[CharacterPhone] Menu item clicked!');
            ...
            try {
                ...
                console.error('[CharacterPhone] Error handling menu click:', error);
                        ...
                        <div class="phone-status-bar">
                            ...
                            <div class="phone-status-icons">
                                <svg class="icon-wifi" viewBox="0 0 24 24">
								    <path d="M12 18.5c.8 0 1.5.7 1.5 1.5S12.8 21.5 12 21.5 10.5 20.8 10.5 20s.7-1.5 1.5-1.5zM6.4 14.7a7.9 7.9 0 0 1 11.2 0l1.1-1.1a9.5 9.5 0 0 0-13.4 0l1.1 1.1zM3 11.3a12.5 12.5 0 0 1 18 0l1.1-1.1a14.2 14.2 0 0 0-20.2 0L3 11.3z" fill="currentColor"/>
                                </svg>
    ...
    openApp(appId) {
        ...
        switch(appId) {
            case 'messages':
                ...
                break;
            case 'browser':
			    this.markAppAsRead('browser');
                appContent = this.renderBrowserApp();
                break;
            case 'wallet':
                this.markAppAsRead('wallet');
				appContent = this.renderWalletApp();
                break;
            case 'notes':
                this.markAppAsRead('notes');
				appContent = this.renderNotesApp();
                break;
            case 'maps':
                this.markAppAsRead('maps');
